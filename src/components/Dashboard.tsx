      ...
      <div className="p-6 bg-white rounded-xl border border-gold-royal/15 shadow-[0_2px_12px_rgba(11,31,58,0.08)] flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-[#4A5568] text-sm">
            Sistem Informasi Notaris &amp; Kearsipan Digital Kantor Notaris & PPAT Rina Maharani S.H., M.Kn. Anda masuk sebagai <span className="text-[#C89B3C] font-semibold capitalize font-mono text-xs px-2 py-0.5 rounded bg-[#F5E6C8] border border-[#C89B3C]/20">{currentUser.role}</span>.
          </p>
        </div>
